    ...
    <footer id="site-footer" class="site-footer">
      <div class="content">
        ...
        <div class="cols">
          ...
          <!-- Column 2: Navigation -->
          <div class="col col-2">
            <nav [attr.aria-label]="t.get('accessibility.footerNavigation')">
          ...
          <div class="col col-3">
            <nav class="social-media" [attr.aria-label]="t.get('accessibility.socialMedia')">
              <ul role="list">
                <li>
                  <a class="facebook" href="https://www.facebook.com/profile.php?id=100063975098177" target="_blank" rel="noopener noreferrer" [attr.aria-label]="t.get('accessibility.facebook')">
                ...
                <li>
                  <a class="youtube" href="https://www.youtube.com/channel/UCJADkkF5DoZC17lm3S0jMqw" target="_blank" rel="noopener noreferrer" [attr.aria-label]="t.get('accessibility.youtube')">
                ...
                <li>
                  <a class="linkedin" href="https://www.linkedin.com/company/les-investissements-rivemont/?originalSubdomain=fr" target="_blank" rel="noopener noreferrer" [attr.aria-label]="t.get('accessibility.linkedIn')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36">
