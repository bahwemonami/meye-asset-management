import { Component, OnInit, signal, inject, AfterViewInit, ChangeDetectionStrategy } from '@angular/core';
              ...
              <div class="description gl-text-editor">
                @switch (currentSection()) {
                  @case ('who') {
                    ...
                    <h4 class="text-color--light-blue">La gestion privée chez MEYE ASSET MANAGER vous offre :</h4>
                    <ul>
                  ...
                  @case ('philosophy') {
                    <p>Chez MEYE ASSET MANAGER, nous croyons que le prix d'un actif n'est pas toujours égal à sa valeur intrinsèque et qu'il est influencé par une multitude de facteurs, notamment les biais cognitifs des investisseurs.</p>
                  ...
                  @case ('why') {
                    <p>Pourquoi choisir MEYE ASSET MANAGER ?</p>
                    <ul>
...
export class PrivateManagementComponent implements OnInit, AfterViewInit {
  ...
  sections = [
    ...
    { id: 'why', title: 'Pourquoi MEYE ASSET MANAGER ?' },
