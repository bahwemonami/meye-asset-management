...
@Component({
  ...
  template: `
    ...
    <section class="relative min-h-screen flex items-center overflow-hidden bg-gradient-to-br from-primary-950 via-primary-900 to-primary-800">
      ...
      <div class="absolute top-20 left-10 w-72 h-72 bg-accent-500/20 rounded-full blur-3xl animate-pulse-slow"></div>
      <div class="absolute bottom-20 right-10 w-96 h-96 bg-primary-500/20 rounded-full blur-3xl animate-pulse-slow animate-delay-500"></div>
        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div class="text-center lg:text-left">
            <div class="inline-flex items-center px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 mb-8 animate-fade-in">
              <span class="w-2 h-2 bg-accent-400 rounded-full animate-pulse mr-3"></span>
              <span class="text-primary-200 text-sm font-medium">Trusted by Institutional Investors</span>
            </div>
            ...
            <p class="text-xl text-primary-200 mb-8 max-w-xl mx-auto lg:mx-0 animate-fade-in-up animate-delay-200">
            ...
            <div class="relative">
              ...
              <div class="bg-white/10 backdrop-blur-xl rounded-3xl p-8 border border-white/20 shadow-2xl">
                <div class="flex items-center justify-between mb-6">
                  <div>
                    <p class="text-primary-300 text-sm">Total Portfolio Value</p>
                    <p class="text-3xl font-bold text-white">$12.4M</p>
                  </div>
                ...
                <!-- Chart Placeholder -->
                <div class="h-48 bg-gradient-to-r from-accent-500/20 to-primary-500/20 rounded-xl flex items-end justify-around p-4">
                  @for (bar of chartBars; track bar.height) {
                    <div class="w-8 bg-gradient-to-t from-accent-500 to-accent-400 rounded-t-lg transition-all duration-500"
                         [style.height.%]="bar.height"></div>
                  }
                </div>
                
                <div class="flex justify-between mt-4 text-sm text-primary-300">
                  <span>Jan</span>
                  <span>Mar</span>
                  <span>May</span>
                  <span>Jul</span>
              ...
              <div class="absolute -top-6 -right-6 bg-white rounded-xl p-4 shadow-elegant animate-float">
                <div class="flex items-center space-x-3">
                  ...
                  <div>
                    <p class="text-xs text-dark-500">Annual Return</p>
                    <p class="font-bold text-green-600">+18.4%</p>
                  </div>
                </div>
              </div>
              
              <div class="absolute -bottom-6 -left-6 bg-white rounded-xl p-4 shadow-elegant animate-float animate-delay-300">
                <div class="flex items-center space-x-3">
                  ...
                  <div>
                    <p class="text-xs text-dark-500">Active Clients</p>
                    <p class="font-bold text-primary-800">240+</p>
                  </div>
                </div>
              </div>
            </div>
    ...
    <section class="section-padding bg-white" #revealSection>
      <div class="container-custom">
        <div class="grid lg:grid-cols-2 gap-16 items-center">
          <div class="reveal">
            <span class="inline-block text-accent-500 font-semibold text-sm tracking-wider uppercase mb-4">Our Mission</span>
            ...
            <div class="space-y-4">
              @for (point of missionPoints; track point.title) {
                <div class="flex items-start space-x-4">
                  <div class="w-10 h-10 rounded-lg bg-primary-100 flex items-center justify-center flex-shrink-0 mt-1">
                    <svg class="w-5 h-5 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                    </svg>
                  </div>
                  <div>
                    <h4 class="font-semibold text-primary-900 mb-1">{{ point.title }}</h4>
          ...
          <div class="reveal-right">
            <div class="relative">
              <div class="aspect-square rounded-3xl bg-gradient-to-br from-primary-100 to-primary-50 p-8">
                <img src="https://images.unsplash.com/photo-1551836022-d5d88e9218df?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" 
                     ...
                     class="w-full h-full object-cover rounded-2xl shadow-elegant">
              </div>
              <div class="absolute -bottom-8 -left-8 bg-white rounded-2xl p-6 shadow-elegant max-w-xs">
                <div class="flex items-center space-x-4 mb-3">
                  ...
                  <div>
                    <p class="text-xs text-dark-500">Trust Score</p>
                    <p class="font-bold text-primary-900 text-xl">98.7%</p>
                  </div>
                </div>
                <p class="text-sm text-dark-600">Based on client satisfaction and verification rate</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-8">
          @for (stat of stats; track stat.label; let i = $index) {
            <div class="text-center reveal" [style.animation-delay.ms]="i * 100">
              ...
              <div class="text-primary-300 text-sm">{{ stat.label }}</div>
            </div>
          }
        </div>
      </div>
    ...
    <section class="section-padding bg-primary-50/50">
      <div class="container-custom">
        <div class="text-center mb-16 reveal">
          <span class="inline-block text-accent-500 font-semibold text-sm tracking-wider uppercase mb-4">Our Services</span>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          @for (service of services; track service.title; let i = $index) {
            <div class="card p-8 group hover:-translate-y-2 transition-all duration-500 reveal" 
              ...
              <div class="w-14 h-14 rounded-2xl bg-gradient-to-br from-primary-100 to-primary-50 flex items-center justify-center mb-6 group-hover:from-accent-100 group-hover:to-accent-50 transition-colors duration-300">
                <span [innerHTML]="service.icon" class="text-primary-600 group-hover:text-accent-600 transition-colors duration-300"></span>
              </div>
              <h3 class="text-xl font-semibold text-primary-900 mb-3">{{ service.title }}</h3>
              <p class="text-dark-500 mb-6">{{ service.description }}</p>
              <a [routerLink]="service.link" class="inline-flex items-center text-primary-700 font-medium text-sm group-hover:text-accent-600 transition-colors duration-300">
                Learn more
    ...
    <section class="section-padding bg-gradient-to-br from-primary-900 via-primary-800 to-primary-900 relative overflow-hidden">
      ...
      <div class="container-custom relative z-10">
        <div class="grid lg:grid-cols-2 gap-16 items-center">
          <div class="reveal">
            <span class="inline-block text-accent-400 font-semibold text-sm tracking-wider uppercase mb-4">Innovation</span>
            <h2 class="text-white mb-6">Digital Proof <span class="text-accent-400">of Control</span></h2>
            ...
            <div class="bg-white/10 backdrop-blur-xl rounded-3xl p-8 border border-white/20">
              <div class="flex items-center justify-between mb-8">
                <div class="flex items-center space-x-3">
                  ...
                  <div>
                    <p class="text-white font-semibold">Digital Certificate</p>
                    <p class="text-primary-300 text-sm">Proof of Control</p>
                  </div>
                </div>
                <span class="px-3 py-1 bg-green-500/20 text-green-400 text-sm font-medium rounded-full">Verified</span>
              </div>
              
              <div class="space-y-4 text-sm">
                <div class="flex justify-between py-3 border-b border-white/10">
                  <span class="text-primary-300">Certificate ID</span>
                  <span class="text-white font-mono">MEYE-2026-001</span>
                </div>
                <div class="flex justify-between py-3 border-b border-white/10">
                  <span class="text-primary-300">Issue Date</span>
                  <span class="text-white">January 26, 2026</span>
                </div>
                <div class="flex justify-between py-3 border-b border-white/10">
                ...
                <div class="flex justify-between py-3">
                  ...
                  <span class="text-white font-mono text-xs">0x8f7...3a2b</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="container-custom">
        <div class="relative bg-gradient-to-br from-primary-800 to-primary-900 rounded-3xl p-12 lg:p-16 overflow-hidden reveal-scale">
          ...
          <div class="relative z-10 text-center max-w-3xl mx-auto">
            <h2 class="text-white mb-6">Ready to <span class="text-accent-400">Take Action?</span></h2>
            <p class="text-primary-200 text-lg mb-8">
